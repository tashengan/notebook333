...
![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAUm9kZ2VI,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center.png)

将原代码（153-154行）修改为如下所示（155行）：

![在这里插入图片描述](assets/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAUm9kZ2VI,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center-1703594623726-3.png)
